...
def run_prime_check(job_size):
    ...
    q = QuestionFreeText(
        question_text="Is {{ number}} prime?", question_name="prime_question"
    )
...
def test_memory_per_interview_decreases_with_scale():
    ...
    small_to_medium = (
        1 - medium_memory_per_interview / small_memory_per_interview
    ) * 100
    medium_to_large = (
        1 - large_memory_per_interview / medium_memory_per_interview
    ) * 100
