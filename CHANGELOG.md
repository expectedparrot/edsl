...
## [0.1.45] - TBD
### Added
- `Results` method `unnest()` allows you to flatten columns of results that are dictionaries (e.g., the response to a `QuestionDict` question) and add them as columns of a new `Results` object that consists of the original results and the new columns. It takes required parameters `keep` and `flatten` which are lists of the names of columns and returns a dataframe. Example: https://www.expectedparrot.com/content/37dbfcc7-a1f1-46d7-ae9a-b45d90fd84d2
