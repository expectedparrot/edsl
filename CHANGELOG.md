...
## [0.1.45] - TBD
### Added
- `Results` method `unnest()` allows you to flatten columns of results that are dictionaries (e.g., the response to a `QuestionDict` question) and add the key/value pairs as new columns of the results. It takes a required parameter `columns` which is a list of the names of columns to unnest. Example: https://www.expectedparrot.com/content/37dbfcc7-a1f1-46d7-ae9a-b45d90fd84d2
