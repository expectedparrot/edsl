...
def example_user_profile_form():
    ...
    profile_questions = [
        ...
        QuestionMultipleChoice(
            "country", "Country:", ["USA", "Canada", "UK", "Germany", "France", "Other"]
        ),
        QuestionNumerical("age", "Age:"),
        QuestionMultipleChoice(
            "occupation",
            "Occupation:",
            ["Student", "Engineer", "Designer", "Manager", "Other"],
        ),
    ]
...
def example_ab_testing():
    ...
    research_questions = [
        QuestionMultipleChoice(
            "age_group", "Age group:", ["18-24", "25-34", "35-44", "45-54", "55+"]
        ),
        QuestionMultipleChoice(
            "income", "Income level:", ["<$30k", "$30k-$50k", "$50k-$80k", "$80k+"]
        ),
        QuestionMultipleChoice(
            "product_interest",
            "Interested in:",
    ...
    known_demographics = {"age_group": "25-34", "income": "$50k-$80k"}
