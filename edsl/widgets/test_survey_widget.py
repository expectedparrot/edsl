...
def test_survey_widget():
    ...
    print(f"✓ Initial state: complete={widget.is_complete}, answers={len(widget.answers)}")
    ...
    if widget.current_question_name:
        ...
        if widget.current_question_html:
            ...
            html_preview = widget.current_question_html[:100] + "..." if len(widget.current_question_html) > 100 else widget.current_question_html
