...
class ScenarioListInspectorWidget(InspectorWidget):
    ...
    widget_short_name = "scenario_list_inspector"
    ...
    def _validate_object(self, obj) -> bool:
        ...
        if obj is None:
            return True
        return (
            hasattr(obj, "scenarios")
            and hasattr(obj, "__len__")
            and hasattr(obj, "__iter__")
        ) or type(obj).__name__ == "ScenarioList"
    ...
    def _enhance_summary(self, summary: Dict[str, Any]):
        ...
        common_variables = [
            var for var, count in variable_counts.items() if count == scenario_count
        ]
