...
class ResultsInspectorWidget(InspectorWidget):
    ...
    def _process_object_data(self):
        ...
        formatted_results["tabular_data"] = tabular_data
    ...
    #                 if i < len(self.object) and hasattr(
    #                     self.object[i], "by_question_data"
    #                 ):
    ...
    #                     processed_result = self._transform_result_data(
    #                         by_question_data, i
    #                     )
    ...
    #                 processed_results.append(
    #                     {"index": i, "error": f"Error processing result {i}: {str(e)}"}
    #                 )
    ...
    #         }
    #         result_data["raw_model_response"][question_name] = question_info.get(
    #             "raw_model_response"
    #         )
    ...
    #         }
    #         result_data["generated_tokens"][question_name] = question_info.get(
    #             "generated_tokens"
    #         )
    #         result_data["comments_dict"][question_name] = question_info.get("comment")
    #         result_data["reasoning_summaries_dict"][question_name] = question_info.get(
    #             "reasoning_summary"
    #         )
    #         result_data["cache_keys"][question_name] = question_info.get("cache_key")
    #         result_data["validated_dict"][question_name] = question_info.get(
    #             "validated"
    #         )
    ...
    #         "question_names": [
    #             q.get("question_name", "") for q in survey_data.get("questions", [])
    #         ],
    #         "question_types": [
    #             q.get("question_type", "") for q in survey_data.get("questions", [])
    #         ],
