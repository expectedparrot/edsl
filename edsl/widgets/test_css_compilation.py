...
def test_css_compilation():
    ...
    essential_classes = [
        # Layout classes
        ".p-5", ".p-4", ".px-4", ".py-2", ".mx-auto", ".max-w-6xl",
        # Flex and grid
        ".flex", ".grid", ".items-center", ".justify-between", ".gap-4",
        # Text styling
        ".text-2xl", ".text-lg", ".text-base", ".text-sm", ".font-bold", ".font-semibold",
        # Colors
        ".bg-white", ".bg-gray-50", ".text-gray-900", ".text-gray-600", ".border-gray-200",
        # Interactive
        ".hover\\:bg-gray-50", ".cursor-pointer", ".transition-colors",
        # Dark mode
        "@media (prefers-color-scheme: dark)", ".dark\\:bg-gray-900", ".dark\\:text-white",
        # Container styling
        ".agent-list-builder",
    ]
