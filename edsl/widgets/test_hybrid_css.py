...
def test_traditional_css_classes():
    ...
    traditional_classes = [
        ...
        ".header-stats{", ".header-stats .left-info{", ".header-stats .right-info{", 
        ".modified-badge{", ".agent-count", ".stat-value{",
        # Error and loading states
        ".error-message{", ".loading-indicator{", ".status-message{",
        # Controls
        ".controls-section{", ".controls-row{", ".control-group{", ".control-label{",
        # Buttons
        ".btn{", ".btn-primary{", ".btn-secondary{", ".btn-success{", ".btn-danger{",
        ".sample-buttons{", ".sample-btn{", ".sample-btn.active{",
        # Table
        ".agent-table{", ".agent-table thead", ".agent-table th{", ".agent-table tbody", ".agent-table td{",
        ".agent-name{", ".agent-traits{", ".trait-item{", ".trait-value{", ".checkbox-cell{",
        # Utility
        ".close-btn{", ".collapsed-view{", ".no-data-message{",
        # Dark mode
