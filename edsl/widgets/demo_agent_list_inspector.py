...
def quick_list_demo():
    ...
    agents = [
        Agent(
            ...
            codebook={"field": "Research field", "experience": "Years of experience", "location": "Work location"}
        ),
        Agent(
            name="Designer", 
            traits={"specialty": "UX", "tools": ["Figma", "Sketch"], "years": 3},
            codebook={"specialty": "Design specialty", "tools": "Design tools used", "years": "Years of experience"}
        ),
        Agent(
            name="Developer",
            traits={"languages": ["Python", "JavaScript"], "role": "Full-stack", "remote": True},
            codebook={"languages": "Programming languages", "role": "Developer role", "remote": "Works remotely"}
        )
    ]
