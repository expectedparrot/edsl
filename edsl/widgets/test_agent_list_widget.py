...
def test_with_agent_list():
    ...
    try:
        ...
        assert summary['agent_count'] == 3, f"Expected 3 agents, got {summary['agent_count']}"
        assert summary['named_agents'] == 3, f"Expected 3 named agents, got {summary['named_agents']}"
...
def test_with_regular_list():
    ...
    try:
        ...
        assert summary['agent_count'] == 2, f"Expected 2 agents, got {summary['agent_count']}"
