...
def demo_resume_survey():
    ...
    questions = [
        QuestionFreeText(
            question_name="participant_name",
        ...
        QuestionMultipleChoice(
            ...
            question_options=["Definitely", "Probably", "Maybe", "Probably not", "Definitely not"]
        ),
        QuestionFreeText(
    ...
    print(f"   Progress: {widget_fresh.progress['current']}/{widget_fresh.progress['total']}")
    ...
    print(f"   Progress: {widget_resumed.progress['current']}/{widget_resumed.progress['total']}")
    ...
    print(f"   Previous answers: {len(widget_near_end.get_answers())} questions answered")
    print(f"   Progress: {widget_near_end.progress['current']}/{widget_near_end.progress['total']}")
...
def demo_conditional_survey_resume():
    ...
    from edsl.surveys import Survey
    from edsl.questions import QuestionMultipleChoice, QuestionFreeText, QuestionNumerical
    from edsl.widgets import SurveyWidget
    ...
    q2_student = QuestionFreeText(
        question_name="school_name", 
        question_text="What school do you attend?"
    )
    ...
    survey.add_rule(q2_professional, "True", q3)  # From company_name, go to years_experience
    ...
    return widget_student, widget_professional, widget_researcher, widget_student_advanced
...
def demo_dynamic_answer_updates():
    ...
    questions = [
        ...
        QuestionMultipleChoice("q2", "Question 2: Pick a color:", ["Red", "Green", "Blue"]),
    ...
    widget.set_initial_answers({"q1": "Another User", "q2": "Blue", "q3": "Almost done!"})
...
def demo_practical_use_cases():
    ...
    questions = [
        ...
        QuestionMultipleChoice("country", "Select your country:", ["USA", "Canada", "UK", "Other"]),
        QuestionNumerical("age", "Enter your age:"),
        QuestionMultipleChoice("interests", "Primary interest:", ["Technology", "Science", "Arts", "Business"])
    ]
