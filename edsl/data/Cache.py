# TODO: Implement Coop as follows:
...
# - Offload as much of the general errors, such as "this key is not valid", etc., to be handled at the level of the Coop client, and handle here what is specific to the Cache.
