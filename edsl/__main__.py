...
from edsl.cli_humanize_helpers import (
    build_route_input as _humanize_build_route_input,
    build_routes_input as _humanize_build_routes_input,
    read_optional_text as _humanize_read_optional_text,
    wait_for_delivery as _humanize_wait_for_delivery,
)
...
def humanize_status(human_survey_uuid):
    ...
    try:
        ...
        coop = Coop()
        data = _jsonable(coop.get_human_survey(human_survey_uuid))
...
def humanize_preview(survey_path, schema_path):
    ...
    try:
        ...
        _output({"preview_url": preview_url})
    except SystemExit:
        raise
    except Exception as e:
        _error(
...
def humanize_qr(human_survey_uuid, output_path):
    ...
    try:
        ...
        qr.save(output_path)
        _output({"human_survey_uuid": human_survey_uuid, "saved_to": output_path})
...
def humanize_respondents(human_survey_uuid, page, page_size):
    ...
    try:
        ...
        _output(_jsonable(Coop().get_human_survey_respondents(
            human_survey_uuid,
            page=page,
            page_size=page_size,
        )))
        ...
        _error("HUMANIZE_ERROR", str(e), exit_code=EXIT_REMOTE)
...
def humanize_schema_patch(human_survey_uuid, schema_path):
    ...
    try:
        ...
        _output(_jsonable(Coop().patch_human_survey_humanize_schema(
            human_survey_uuid,
...
def humanize_css_patch(human_survey_uuid, css_path, clear):
    ...
    try:
        ...
        _output(_jsonable(Coop().patch_human_survey_css(human_survey_uuid, css)))
    except SystemExit:
        raise
    except Exception as e:
        _error("HUMANIZE_ERROR", str(e), exit_code=EXIT_REMOTE)
...
def humanize_agent_list_get(human_survey_uuid):
    ...
    try:
        ...
        _output(_jsonable(Coop().get_human_survey_agent_list(human_survey_uuid)))
    except SystemExit:
        raise
    except Exception as e:
        _error("HUMANIZE_ERROR", str(e), exit_code=EXIT_REMOTE)
...
def humanize_agent_list_patch(human_survey_uuid, delivery_map_path, anonymous, allow_resubmit):
    ...
    try:
        ...
        _output(_jsonable(Coop().patch_human_survey_agent_list(
            human_survey_uuid,
...
def humanize_deliveries_list(human_survey_uuid, page, page_size):
    ...
    try:
        ...
        _output(_jsonable(Coop().list_human_survey_deliveries(
            human_survey_uuid,
            page=page,
            page_size=page_size,
        )))
...
def humanize_deliveries_create(
    ...
    try:
        ...
        _output(_jsonable(Coop().create_human_survey_delivery(
            human_survey_uuid,
            name=name,
...
def humanize_deliveries_get(human_survey_uuid, delivery_uuid):
    ...
    try:
        ...
        _output(_jsonable(Coop().get_human_survey_delivery(human_survey_uuid, delivery_uuid)))
    except SystemExit:
        raise
    except Exception as e:
        _error("HUMANIZE_ERROR", str(e), exit_code=EXIT_REMOTE)
...
def humanize_deliveries_tasks(human_survey_uuid, delivery_uuid, page, page_size):
    ...
    try:
        ...
        _output(_jsonable(Coop().list_human_survey_delivery_tasks(
            human_survey_uuid,
            delivery_uuid,
            page=page,
            page_size=page_size,
...
def humanize_deliveries_task(human_survey_uuid, task_uuid):
    ...
    try:
        ...
        _output(_jsonable(Coop().get_human_survey_delivery_task(human_survey_uuid, task_uuid)))
    except SystemExit:
        raise
    except Exception as e:
        _error("HUMANIZE_ERROR", str(e), exit_code=EXIT_REMOTE)
...
def humanize_deliveries_wait(human_survey_uuid, delivery_uuid, poll_interval, timeout):
    ...
    if poll_interval <= 0:
        _error("USAGE_ERROR", "--poll_interval must be greater than 0.", exit_code=EXIT_USAGE)
    if timeout is not None and timeout <= 0:
        _error("USAGE_ERROR", "--timeout must be greater than 0.", exit_code=EXIT_USAGE)
    try:
        from edsl.coop import Coop

        coop = Coop()
        _output(_wait_for_humanize_delivery(
            coop,
            human_survey_uuid,
            delivery_uuid,
...
def humanize_schedules_list(human_survey_uuid, page, page_size):
    ...
    try:
        ...
        _output(_jsonable(Coop().list_human_survey_schedules(
            human_survey_uuid,
            page=page,
            page_size=page_size,
        )))
...
def humanize_schedules_get(human_survey_uuid, schedule_uuid):
    ...
    try:
        ...
        _output(_jsonable(Coop().get_human_survey_schedule(human_survey_uuid, schedule_uuid)))
    except SystemExit:
        raise
    except Exception as e:
        _error("HUMANIZE_ERROR", str(e), exit_code=EXIT_REMOTE)
...
def humanize_schedules_create_one_time(
    ...
    try:
        ...
        _output(_jsonable(Coop().create_human_survey_one_time_schedule(
            human_survey_uuid,
            name=name,
            run_at=run_at,
            routes=_build_routes_input(
...
def humanize_schedules_create_cron(
    ...
    try:
        ...
        _output(_jsonable(Coop().create_human_survey_cron_schedule(
            human_survey_uuid,
            name=name,
...
def humanize_schedules_update_one_time(human_survey_uuid, schedule_uuid, run_at):
    ...
    try:
        ...
        _output(_jsonable(Coop().update_human_survey_one_time_schedule(
            human_survey_uuid,
            schedule_uuid,
            run_at=run_at,
        )))
...
def humanize_schedules_update_cron(human_survey_uuid, schedule_uuid, cron_expression, timezone, max_jobs, deadline, start_at):
    ...
    try:
        ...
        _output(_jsonable(Coop().update_human_survey_cron_schedule(
            human_survey_uuid,
            schedule_uuid,
            cron_expression=cron_expression,
            timezone=timezone,
...
def humanize_schedules_delete(human_survey_uuid, schedule_uuid):
    ...
    try:
        ...
        _output(_jsonable(Coop().delete_human_survey_schedule(human_survey_uuid, schedule_uuid)))
    except SystemExit:
        raise
    except Exception as e:
        _error("HUMANIZE_ERROR", str(e), exit_code=EXIT_REMOTE)
...
def humanize_schedules_route_add(
    ...
    try:
        ...
        _output(_jsonable(Coop().add_human_survey_schedule_route(
            human_survey_uuid,
            schedule_uuid,
            _build_route_input(
                route_path,
...
def humanize_schedules_route_delete(human_survey_uuid, schedule_uuid, route_uuid):
    ...
    try:
        ...
        _output(_jsonable(Coop().delete_human_survey_schedule_route(
            human_survey_uuid,
            schedule_uuid,
            route_uuid,
        )))
...
def humanize_schedules_route_patch_respondent_email(human_survey_uuid, schedule_uuid, route_uuid, template_file, respondent_filter_path, subject):
    ...
    try:
        ...
        _output(_jsonable(Coop().patch_human_survey_schedule_respondent_email_route(
            human_survey_uuid,
            schedule_uuid,
            route_uuid,
...
def humanize_callbacks_list(human_survey_uuid, page, page_size):
    ...
    try:
        ...
        _output(_jsonable(Coop().list_human_survey_callbacks(
            human_survey_uuid,
            page=page,
            page_size=page_size,
        )))
...
def humanize_callbacks_create(
    ...
    try:
        ...
        _output(_jsonable(Coop().create_human_survey_callback(
            human_survey_uuid,
            name=name,
...
def humanize_callbacks_get(human_survey_uuid, callback_uuid):
    ...
    try:
        ...
        _output(_jsonable(Coop().get_human_survey_callback(human_survey_uuid, callback_uuid)))
    except SystemExit:
        raise
    except Exception as e:
        _error("HUMANIZE_ERROR", str(e), exit_code=EXIT_REMOTE)
...
def humanize_callbacks_patch(human_survey_uuid, callback_uuid, name):
    ...
    try:
        ...
        _output(_jsonable(Coop().patch_human_survey_callback(
            human_survey_uuid,
            callback_uuid,
            name=name,
        )))
...
def humanize_callbacks_delete(human_survey_uuid, callback_uuid):
    ...
    try:
        ...
        _output(_jsonable(Coop().delete_human_survey_callback(human_survey_uuid, callback_uuid)))
    except SystemExit:
        raise
    except Exception as e:
        _error("HUMANIZE_ERROR", str(e), exit_code=EXIT_REMOTE)
...
def humanize_callbacks_route_add(
    ...
    try:
        ...
        _output(_jsonable(Coop().add_human_survey_callback_route(
            human_survey_uuid,
            callback_uuid,
            _build_route_input(
                route_path,
...
def humanize_callbacks_route_delete(human_survey_uuid, callback_uuid, route_uuid):
    ...
    try:
        ...
        _output(_jsonable(Coop().delete_human_survey_callback_route(
            human_survey_uuid,
            callback_uuid,
            route_uuid,
        )))
...
def humanize_callbacks_route_patch_respondent_email(human_survey_uuid, callback_uuid, route_uuid, template_file, respondent_filter_path, subject):
    ...
    try:
        ...
        _output(_jsonable(Coop().patch_human_survey_callback_respondent_email_route(
            human_survey_uuid,
            callback_uuid,
            route_uuid,
            delivery_template=_read_optional_text(template_file),
...
def _set_humanize_schedule_active(human_survey_uuid, schedule_uuid, is_active):
    try:
        ...
        _output(_jsonable(Coop().set_human_survey_schedule_active(
            human_survey_uuid,
            schedule_uuid,
            is_active,
        )))
...
def _set_humanize_callback_active(human_survey_uuid, callback_uuid, is_active):
    try:
        ...
        _output(_jsonable(Coop().set_human_survey_callback_active(
            human_survey_uuid,
            callback_uuid,
            is_active,
        )))
...
def _read_json_or_gzip(path: str) -> dict:
    return _read_serialized_object(Path(path))
...
def _build_routes_input(
    ...
    return _humanize_build_routes_input(
        routes_path,
        owner_email_template,
        respondent_email_template,
        template_file,
...
def _build_route_input(
    ...
    return _humanize_build_route_input(
        route_path,
        owner_email_template,
        respondent_email_template,
        template_file,
...
def _read_optional_text(path: Optional[str]) -> Optional[str]:
    return _humanize_read_optional_text(path)


def _humanize_usage_error(message: str) -> None:
    _error("USAGE_ERROR", message, exit_code=EXIT_USAGE)
...
def _wait_for_humanize_delivery(
    ...
    return _jsonable(_humanize_wait_for_delivery(
        coop,
        human_survey_uuid,
        delivery_uuid,
        poll_interval,
