...
class AgentChat:
    ...
    def send_message(self, message: str) -> str:
        ...
        self.agent.instruction = f"This is your conversation history so far: {self.history}"
    ...
    def to_results(self) -> Results:
        ...
        if not self._questions or not self._answers:
            raise ValueError("No questions or answers available. Run some chat interactions first.")
            ...
            while True:
                ...
                if user_input.lower() in ['/exit', '/quit']:
                    ...
                    try:
                        ...
                        self.console.print(f"[bold green]✓[/bold green] Successfully converted to Results object with {len(results)} responses")
                        self.console.print(f"[dim]Access via: chat.to_results()[/dim]")
