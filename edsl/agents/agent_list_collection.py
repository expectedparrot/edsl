...
class PersonaGenerator:
    ...
    def generate_from_collection(self, source_collection: 'AgentListCollection') -> 'AgentListCollection':
    ...
    def _get_agent_list_names(self, source_collection: 'AgentListCollection') -> List[str]:
...
class AgentListCollection(ItemCollection):
    ...
    def example(cls) -> 'AgentListCollection':
        ...
        Example:
            ...
            True
        """
        return cls([AgentList.example(), AgentList.example()], name = "Example AgentListCollection")
