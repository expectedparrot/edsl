    ...
    async def get_tokens(
        ...
        if amount >= self.capacity:
            if not cheat_bucket_capacity:
                ...
                print(
                    f"""The requested amount, {amount}, exceeds the current bucket capacity of {self.capacity}. 
                      Increasing bucket capacity to {amount * 1.10} accommodate the requested amount."""
                )
