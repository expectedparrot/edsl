...
class AnswerQuestionFunctionConstructor:
    ...
    def _skip_this_question(self, current_question: "QuestionBase") -> bool:
        current_question_index = self.interview.to_index[current_question.question_name]
        answers = (
            self.interview.answers
            | self.interview.scenario
            | self.interview.agent["traits"]
        )
        return self.interview.survey.rule_collection.skip_question_before_running(
    ...
    def _handle_exception(
        ...
        answers = copy.copy(self.interview.answers)
