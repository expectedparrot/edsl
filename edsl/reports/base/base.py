...
from edsl import QuestionFreeText, FileStore, Scenario
...
class Output(ABC):
    ...
    def get_questions_html(self):
        ...
        for q in self.questions:
            html_parts.append(f'<div class="question-details">')
            html_parts.append(f'<h3>Question Details:</h3>')
            html_parts.append(f'<div class="question-metadata">')
            ...
            if hasattr(q, 'question_options'):
                ...
                html_parts.append(f'<p><strong>Options:</strong> {", ".join(str_options)}</p>')
