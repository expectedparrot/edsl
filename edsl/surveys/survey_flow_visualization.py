...
class SurveyFlowVisualization:
    ...
    def show_flow(self, filename: Optional[str] = None, verbose: bool = True):
        ...
        params = {
            ...
            "scenario": self.scenario.to_dict() if hasattr(self.scenario, 'to_dict') else None,
            "agent": self.agent.to_dict() if self.agent and hasattr(self.agent, 'to_dict') else None,
            "filename": filename,
        }
