...
class Survey(Base):
    ...
    def _get_question_by_name(self, question_name: str) -> QuestionBase:
        ...
        Question('multiple_choice', question_name = \"""q0\""", question_text = \"""Do you like school?\""", question_options = ['yes', 'no'], use_code = True)
        """
        if question_name not in self.question_name_to_index:
    ...
    def gen_path_through_survey(self) -> Generator[QuestionBase, dict, None]:
        ...
        Examples:
            ...
            Question('multiple_choice', question_name = \"""q2\""", question_text = \"""Why?\""", question_options = ['**lack*** of killer bees in cafeteria', 'other'], use_code = True)
            ...
            Question('multiple_choice', question_name = \"""q1\""", question_text = \"""Why not?\""", question_options = ['killer bees in cafeteria', 'other'], use_code = True)
        """
