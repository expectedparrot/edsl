...
class SurveyCodec:
    ...
    def encode(self, obj: Union["QuestionBase", "Instruction", "ChangeInstruction", dict[str, Any]]) -> dict[str, Any]:
    ...
    def decode(self, data: dict[str, Any]) -> Union["QuestionBase", "Instruction", "ChangeInstruction"]:
