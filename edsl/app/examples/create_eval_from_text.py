...
# Create an agent with expert knowledge and run the surveyjobs_object = 
...
# Composite app
app = CompositeApp(
    first_app=jeopardy_app,
    second_app=answering_app,
    bindings={
...
"""
    ...
    # Run the composite app - it generates questions and answers them with an expert agent
    results = app.output(params={'input_text': text, 'words_per_chunk': 100})
