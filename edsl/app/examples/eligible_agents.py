...
app = App(
    ...
    display_name="Eligible Agents Finder",
    short_description="Find eligible agents based on criteria.",
    long_description="This application identifies and filters agents that meet specific eligibility criteria, useful for targeted surveys and research studies requiring specific respondent characteristics.",
