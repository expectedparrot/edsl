...
from edsl.questions import QuestionCompute, QuestionNumerical, QuestionLinearScale, QuestionMultipleChoice
...
# Output formatter
output_formatter = (OutputFormatter(description="Sample Size Calculator Results")
...
app = App(
    ...
    A sample size calculator for research studies.

    This app helps you determine:
    - The sample size needed for your study
    - The margin of error for an existing sample
    - How many people to invite to reach your target sample size

    It accounts for confidence levels, expected response rates, and finite population corrections.
    """),
...
if __name__ == "__main__":
    ...
    print(f"Required sample size: {result1[0]['answer']['sample_size']}")
    ...
    print(f"Margin of error: ±{result2[0]['answer']['margin_of_error_calc']}%")
    ...
    print(f"Number to invite: {result3[0]['answer']['number_to_invite']}")
    print(f"(Assuming {result3[0]['scenario']['expected_response_rate']*100}% response rate)")
    print("=" * 60)
