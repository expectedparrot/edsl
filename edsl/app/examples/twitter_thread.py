...
from edsl.questions import QuestionFreeText, QuestionLinearScale, QuestionMultipleChoice, QuestionFileUpload
...
initial_survey = Survey([
    QuestionFileUpload(
        question_name="paper",
        question_text="Please upload your academic paper"
    ),
    QuestionMultipleChoice(
        question_name="target_audience",
        question_text="Who is your target audience?",
        question_options=["Academic researchers", "Industry professionals", "General public", "Policy makers"]
    ),
    QuestionLinearScale(
        ...
        option_labels={5: "5 tweets", 7: "7 tweets", 10: "10 tweets", 12: "12 tweets", 15: "15 tweets"}
    ),
    QuestionMultipleChoice(
        question_name="tone",
        question_text="What tone should the thread have?",
        question_options=["Professional/Academic", "Conversational/Accessible", "Enthusiastic/Promotional"]
    )
])
