...
class TestHuggingFaceLoader:
    ...
    def test_missing_datasets_library(self):
        ...
        with patch(
            "edsl.scenarios.hugging_face.loader.load_dataset", side_effect=ImportError()
        ):
    ...
    def test_single_config_dataset(self):
        ...
        with patch(
            "edsl.scenarios.hugging_face.loader.load_dataset", return_value=mock_dataset
        ):
            with patch(
                "edsl.scenarios.hugging_face.loader.get_dataset_config_names",
    ...
    def test_multiple_splits_without_train(self):
        ...
        # Mock the dataset structure
        mock_dataset = {"validation": MagicMock(), "test": MagicMock()}
        mock_df = MagicMock()
        mock_df.to_dict.return_value = [
