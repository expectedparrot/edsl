...
class QualtricsSurveyBuilder:
    ...
    def build(self) -> Survey:
        ...
        self._add_matrix_questions(matrix_groups, remaining_columns, all_questions_with_position)
    ...
    def _add_matrix_questions(
        ...
        for matrix_group in matrix_groups:
            try:
                matrix_question = self.matrix_detector.create_matrix_question(matrix_group)
                ...
                all_questions_with_position.append((first_column_index, matrix_question))
                
                if self.verbose:
                    print(f"Created matrix question: {matrix_question.question_name} "
                ...
                if self.verbose:
                    print(f"Warning: Could not create matrix question "
