...
class SurveyBuilder(ABC, UserDict):
    ...
    def __init__(
        ...
        ## responses format: {'q1': ['1', '4'], 'q2': ['2', '5'], 'q3': ['3', '6']}

        self.question_name_to_text = CustomDict(self.get_question_name_to_text())
        ## question_name_to_text format: {'Q1': 'Q1', 'Q2': 'Q2', 'Q3': 'Q3'}
        ...
        ## {'q1': RawResponseColumn, 'q2': RawResponseColumn, 'q3': RawResponseColumn}
        self.data = {}
    ...
    def create_agents(
        ...
        for observation in observations: # iterate through the observations 
            traits = {}
