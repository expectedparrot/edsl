...
stop_words = {'into', "mustn't", 'there', "you'll", 'don', 'have', 'at', 'if', 'on', 'some', 'with', 'in', 'can', 'mightn', 'off', 'few', 'not', 'd', 'hadn', "shan't", 't', 're', 'where', 's', "won't", 'mustn', "wasn't", "didn't", 'has', 'same', 'too', 'will', "you've", 'all', "haven't", "isn't", 'over', 'of', 'about', 'its', 'being', 'it', 'her', 'should', 'himself', 'wasn', 'out', 'theirs', 'aren', 'that', 'our', "shouldn't", "you'd", 'such', 'above', 'my', 'the', 'any', 'been', 'as', 'very', 'herself', 'o', 'weren', 'until', 'their', 'shouldn', 'up', 'wouldn', "couldn't", "hasn't", 'no', 'than', "hadn't", 'had', 'you', 'here', 'yourself', 'yourselves', 'during', 'ain', 'once', "aren't", 'what', 'so', 'hers', "that'll", 'other', 'ours', 'yours', 'nor', 'him', 'doesn', "doesn't", 'he', 'them', 'for', 'll', 'isn', 'this', 'or', 'who', 'only', 'itself', 'they', 'between', 'against', 'under', 'me', 'now', "mightn't", 'those', "needn't", 'these', 'when', 'before', 'his', "she's", 'having', 'be', "don't", 'haven', 'won', 'while', 'both', 'didn', 'by', 'ourselves', 'm', 'your', 'then', 'myself', 'we', "it's", "should've", 'through', 'why', 'from', 'and', 'hasn', 'more', 'how', 've', 'most', 'because', 'did', 'y', 'i', 'an', 'but', 'whom', 'below', 'further', 'am', 'which', 'just', 'ma', "you're", 'couldn', 'do', 'shan', 'own', 'again', 'are', "weren't", 'down', 'is', 'were', 'each', 'needn', 'themselves', 'she', 'after', 'does', "wouldn't", 'to', 'a', 'was', 'doing'}
