...
class HeadAttachmentsBuilder:
    """Build `HeadAttachments` from macro params and initial survey.

    Extracted from `Macro._prepare_from_params` for clarity and testability.
    """

    @staticmethod
    def build(macro: "Macro", params: dict[str, Any]):
        ...
        for k, v in getattr(macro, "fixed_params", {}).items():
