...
# 5. Jobs Pipeline
color_survey_pipeline = Survey([generate_survey_question, analyze_colors_question]).by(
...
# 7. Complete Macro Instance
macro = Macro(
    application_name="color_survey",
    display_name="Color Survey",
    short_description="Survey about color preferences.",
    long_description="This application collects and analyzes color preferences and associations, useful for design research, branding studies, and understanding aesthetic preferences across demographics.",
...
if __name__ == "__main__":
    # Test the macro with sample parameters
    print("Running Color Survey Macro...")
    ...
    print("\n" + "=" * 50)
    print("COLOR SURVEY MACRO RESULTS")
    print("=" * 50)
    print(results)
