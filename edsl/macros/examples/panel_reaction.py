...
macro = Macro(
    ...
    long_description="This application collects reactions from a panel of agents with different perspectives. Users provide a survey, and the macro runs it across multiple agents (like cheese lovers and cheese haters) to capture diverse viewpoints.",
