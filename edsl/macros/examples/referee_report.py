...
initial_survey = Survey(
    [
        QuestionFileUpload(
            question_name="paper", question_text="Please upload your paper"
        )
    ]
)
...
macro = Macro(
    ...
    long_description="This application assists in generating structured academic referee reports for paper reviews, providing evaluation criteria and constructive feedback across multiple dimensions.",
    application_name="referee_report",
    display_name="Referee Report Generator",
...
if __name__ == "__main__":
    ...
    # NOTE: This example may timeout due to multiple rounds of LLM calls with large contexts
    # Consider reducing the number of referees or models for faster execution
    # Example disabled by default to prevent timeout
    print("Example disabled - this macro requires significant LLM processing time")
    print("To run, uncomment the following line and ensure you have API access:")
    # macro.output({'paper': "optimize.pdf"})
