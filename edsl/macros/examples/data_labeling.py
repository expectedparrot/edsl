...
labeling_question = QuestionYesNo(
    question_name="in_asia", question_text="Is this city in Asia? {{ scenario.City }}"
)

of = (
    OutputFormatter(description="Data Labeling", output_type="table")
    .select("City", "answer.*", "generated_tokens.*")
    .table()
)
