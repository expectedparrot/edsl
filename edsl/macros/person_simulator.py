...
def create_person_simulator(
    ...
    """Create a Macro that answers questions in character using a provided persona context.
    ...
    Returns:
        Macro: Configured macro instance for persona simulation.
    """
...
def create_person_simulator_from_directory(
    ...
    *,
    ...
    """Create a PersonSimulator Macro by extracting text from files in a directory.
    ...
    Returns:
        Macro: Configured macro instance with aggregated context from directory.
    """
...
def create_person_simulator_from_firecrawl(
    ...
    *,
    ...
    """Create a PersonSimulator Macro by attempting to fetch context via Firecrawl.
    ...
    Returns:
        Macro: Configured macro instance with context from web search or fallback.
    """
...
class PersonSimulator:
    """Factory class for creating PersonSimulator Macros.

    This class provides a backward-compatible interface to the factory functions.
    It returns Macro instances rather than inheriting from Macro.
    """
    ...
    def __new__(
        ...
        Args:
            persona_context: Descriptive text about the person/persona to simulate.
            application_name: Valid Python identifier for the macro (defaults to 'person_simulator').
            display_name: Human-readable name (defaults to 'Person Simulator').
            short_description: One sentence description.
            long_description: Longer description.
            agent_name: Optional name for the simulated persona.
    ...
    def from_directory(
        ...
        *,
        ...
        Args:
            directory_path: Directory containing files to build the persona from.
            agent_name: Optional agent name.
            application_name: Valid Python identifier for the macro.
            display_name: Human-readable name.
            short_description: One sentence description.
            long_description: Longer description.
            output_formatters: Optional output formatters dict.
