...
class Question(metaclass=Meta):
    ...
    def list_question_types(cls):
        ...
        ['checkbox', 'compute', 'demand', 'diagram', 'dict', 'dropdown', 'edsl_object', 'extract', 'file_upload', 'free_text', 'functional', 'image_generation', 'interview', 'likert_five', 'linear_scale', 'list', 'markdown', 'matrix', 'multiple_choice', 'multiple_choice_with_other', 'numerical', 'pydantic', 'random', 'rank', 'thinking', 'top_k', 'yes_no']
        """
        return [
            q
            for q in sorted(
