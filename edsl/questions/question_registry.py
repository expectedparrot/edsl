...
class Question(metaclass=Meta):
    ...
    def list_question_types(cls):
        ...
        ['checkbox', 'checkbox_with_other', 'compute', 'demand', 'diagram', 'dict', 'dropdown', 'edsl_object', 'extract', 'file_upload', 'free_text', 'functional', 'image_generation', 'interview', 'likert_five', 'linear_scale', 'list', 'markdown', 'matrix', 'multiple_choice', 'multiple_choice_with_other', 'numerical', 'pydantic', 'random', 'rank', 'survey_message', 'thinking', 'top_k', 'url', 'yes_no']
        """
        return [
            q
            for q in sorted(
