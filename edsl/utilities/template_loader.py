"""Template loader for working with Jinja templates."""
...
class TemplateLoader(BaseLoader):
    """Custom Jinja2 template loader for loading templates from packages."""
    ...
    def get_source(self, environment, template):
        """Get the template source from the package."""
        try:
