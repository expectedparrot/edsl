...
class OptimizationResults:
    ...
    def print_summary(self):
        ...
        console.print(f"🚀 Optimized agents: {self.summary.get('optimized_agent_count', 0)}")
        console.print(f"📈 Success rate: {self.summary.get('improvement_rate', 0):.1%}")
        
        if self.summary.get('average_perfect_questions'):
            console.print(f"⭐ Avg perfect questions: {self.summary.get('average_perfect_questions', 0):.1%}")
