...
class CompareCandidates:
    ...
    def __init__(self, results_comparison_a: "ResultPairComparison", results_comparison_b: "ResultPairComparison"):
    ...
    def compare(self) -> "ScenarioList":
        ...
        # Get metric names
        metric_names = [str(fn) for fn in self.results_comparison_a.comparison_factory.comparison_fns]
    ...
    def _determine_winner(self, value_1: Any, value_2: Any, tie_threshold: float = 0.001) -> str:
