...
class ReturnAnalyzer(ast.NodeVisitor):
    ...
    def _analyze_dict(self, node: ast.Dict) -> ReturnStructure:
        ...
        for key_node, value_node in zip(node.keys, node.values):
            ...
            if isinstance(value_node, ast.Dict):
                ...
                # Literal values
                literal_values[key] = value_node.s if isinstance(value_node, ast.Str) else value_node.value
            else:
    ...
    def get_return_definitions(self, func_or_source: Union[str, ast.AST, callable]) -> Dict[str, ReturnDefinition]:
    ...
    def analyze_return_value(self, func_or_source: Union[str, ast.AST, callable]) -> Optional[ReturnStructure]:
