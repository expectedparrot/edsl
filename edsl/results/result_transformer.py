    ...
    def by_question_data(
        ...
        for data_type, sub_dict in self.data.items():
            ...
            if data_class is None:
                ...
                continue
            for question_name, values in (
                data_class(sub_dict).generate_by_question_dict().items()
            ):
...
if __name__ == "__main__":
    ...
    print(
        "Classes with special keys:",
        ResultComponentDict.get_subclasses_with_special_keys(),
    )
