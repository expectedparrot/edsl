...
class SourceQuestionAgentResponseMap(UserDict):
    ...
    def generate_special_comparisons(self, source: str, question_name: str) -> Generator[Evaluation, None, None]:
        ...
        Examples:
            ...
            True
        """
        r1_gold = self.get_gold_standard_answers(source, question_name, use_method_name = False)
    ...
    def _special_comparison(self, source: str, question_name: str, method_name: str, use_method_name: bool = True) -> Responses:
        ...
        return Responses(source = method_name if use_method_name else source, question_name = question_name, answer_dict = new_answers)

    def get_gold_standard_answers(self, source: str, question_name: str, use_method_name: bool = True) -> Responses:
        ...
        Examples:
            ...
            True
        """
        return self._special_comparison(source, question_name, 'gold_standard', use_method_name = False)
    
    def get_shuffled_answers(self, source: str, question_name: str, use_method_name: bool = True) -> Responses:
        ...
        Examples:
            ...
            True
        """
        return self._special_comparison(source, question_name, 'shuffled', use_method_name = use_method_name)
    
    def get_random_answers(self, source: str, question_name: str, use_method_name: bool = True) -> Responses:
        ...
        Examples:
            ...
            True
        """
        return self._special_comparison(source, question_name, 'random', use_method_name = use_method_name)
    
    def modal_answers(self, source: str, question_name: str, use_method_name: bool = True) -> Responses:
        ...
        Examples:
            ...
            True
        """
        return self._special_comparison(source, question_name, 'modal', use_method_name = use_method_name)
