...
class ObjectEntry:
    ...
    def __init__(self, variable_name:str, object, description, coop_info=None, created_at=None, edsl_class_name=None):
    ...
    def push(self, refresh=False) -> dict:
        if self.coop_info is None or refresh:
            ...
            print(f"Object {self.variable_name} pushed to coop with info: {self._coop_info}")
        else:
            print(f"Object {self.variable_name} already pushed to coop with info: {self._coop_info}")
