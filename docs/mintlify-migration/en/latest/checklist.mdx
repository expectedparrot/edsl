...
7. *Optional:* Store and share your work at the [Expected Parrot](https://www.expectedparrot.com/content/explore): a platform for AI research that is fully integrated with EDSL. [Learn more](/en/latest/coop).
