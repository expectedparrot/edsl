...
Code and results for the example below are also accessible at a downloadable [notebook at Coop](https://www.expectedparrot.com/content/RobinHorton/human-results-example-notebook).
