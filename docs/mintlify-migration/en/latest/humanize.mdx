...
This page provides information about EDSL code methods for launching surveys, gathering human responses, and analyzing results from your workspace. For more information about building surveys interactively, see the [Survey Builder](/en/latest/survey_builder) page. For more information about launching studies with Prolific participants, see the [Prolific studies](/en/latest/prolific) page.
</Note>
...
<Steps>
<Step>
    **Create** [Surveys](/en/latest/surveys) with desired types of [Questions](/en/latest/questions), and design AI [Agents](/en/latest/agents) to answer them. Select [Language Models](/en/latest/language_models) to generate the responses.
</Step>
<Step>
    **Run** your survey with agents and language models, generating a formatted dataset of [Results](/en/latest/results).
</Step>
<Step>
...
<Step>
    **Share** the web survey with human respondents. (See the [Prolific studies](/en/latest/prolific) page for information about launching studies with Prolific participants.)
</Step>
<Step>
...
Code and results for the example below are also accessible at a downloadable [notebook at Expected Parrot](https://www.expectedparrot.com/content/RobinHorton/human-results-example-notebook).
...
# Create an Expected Parrot client instance
coop = Coop()

# Get human responses from Expected Parrot
