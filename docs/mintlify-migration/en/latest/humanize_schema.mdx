...
<ParamField path="questions" type="dict" required={false}>
  ...
  <Expandable title="properties">
    ...
    <ParamField path="questions.question_name.custom_validation" type="object" required={false}>
...
humanize_schema = {
    "questions": {
        ...
        "rating": {"optional": False, "format": {"type": "dropdown"}, "custom_validation": {"select_exact_answer": "Good"}},
    },
