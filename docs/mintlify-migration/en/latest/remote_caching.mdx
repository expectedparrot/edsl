...
<Note>
*Note: You must have a Expected Parrot account in order to use remote inference and caching. By using remote inference you agree to any terms of use of service providers, which Expected Parrot may accept on your behalf and enforce in accordance with our terms of use.*
</Note>
...
Results that were generated at the Expected Parrot server will show a verified checkmark ✓ at Expected Parrot. If you rerun a survey with verified results you will retrieve stored responses.
</Accordion>
...
<Frame>
![Page displaying a remote cache at the Expected Parrot platform](/images/en/latest/home-remote-cache-logs.png)
</Frame>
