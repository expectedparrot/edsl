...
Expected Parrot is a platform for creating, storing and sharing LLM-based research. It is fully integrated with EDSL, allowing you to access objects from your workspace or Expected Parrot account interface. [Learn more about creating an account and using Expected Parrot](/en/latest/coop).
