...
Here we create a scenario for a [Google Form](https://forms.gle/GufjVVs5PfxUeyoj7) (a customer feedback survey) that we have stored as a publicly-accessible PDF at [Expected Parrot](https://www.expectedparrot.com/content/explore).
...
Retrieving a file (replace with UUID of any desired object at Expected Parrot):
```
