...
For instructions on using your Expected Parrot key only for accessing Expected Parrot, please see the [Expected Parrot section](/en/latest/coop) of the documentation.
...
This method provides a secure way to store your keys and the most flexibility in choosing how to use them. It requires a Expected Parrot account ([log in/sign up here](https://www.expectedparrot.com/login)) and works with remote-inference.
...
This key allows you to access all available models at once and use remote-inference to run surveys at the Expected Parrot server. It also allows you to post content to Expected Parrot, and to interact with other content that is public or shared with you.
