...
Your Expected Parrot key can also be found at the [Keys](http://www.expectedparrot.com/home/keys) page of your account, where you can reset it at any time. This key allows you to access all available models at once and use remote-inference to run surveys at the Expected Parrot server. It also allows you to post content to the platform, and to interact with other content that is public or shared with you.
