...
**Expected Parrot Domain-Specific Language (EDSL)** is an open-source Python package for conducting research with AI agents and language models. Create an [Expected Parrot account](https://www.expectedparrot.com/login) to run surveys remotely, store and share results, and collaborate with other users.

- Install EDSL from [PyPI](https://pypi.org/project/edsl/): `pip install edsl`. Source code at [GitHub](https://github.com/expectedparrot/edsl).
- [Create an account](https://www.expectedparrot.com/login) to post and share content, run surveys with LLMs and humans, and store results. Start [exploring](https://www.expectedparrot.com/content/explore).
