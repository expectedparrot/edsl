...
description: "Remote inference allows you to run surveys at the Expected Parrot server instead of locally on your own machine, and to use [Remote Caching](/en/latest/remote_caching) to store survey results and logs at your Expected Parrot account."
---
...
[Log in](https://www.expectedparrot.com/login) to your Expected Parrot account and navigate to your [Settings](https://www.expectedparrot.com/home/settings) page. Toggle on the remote inference setting:
...
An Expected Parrot key is required to use remote inference and to interact with Expected Parrot. Your key can be viewed (and reset) at the [Keys](https://www.expectedparrot.com/home/keys) page of your account:
...
<Frame>
![Remote inference page on the Expected Parrot platform. There is one job shown, and it has a status of "Completed."](/images/en/latest/home-remote-inference-job-completed.png)
</Frame>

We can view the results of the job:

<Frame>
![Remote inference results page on the Expected Parrot platform. There is one result shown.](/images/en/latest/coop-content-results-view.png)
</Frame>
...
<Frame>
![A screenshot of job history logs on the Expected Parrot platform. The job has been run using a key that has been prioritized.](/images/en/latest/home-remote-cache-job-history-details.png)
</Frame>
