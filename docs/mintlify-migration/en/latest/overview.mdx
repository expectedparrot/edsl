...
**Notebook Integration:** EDSL is ideally used within a notebook environment, facilitating the execution and detailed analysis of research outcomes.
...
- Create an [Expected Parrot account](https://www.expectedparrot.com/login).
