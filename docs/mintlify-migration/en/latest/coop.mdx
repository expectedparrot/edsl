...
description: "The Coop module is EDSL's interface to Expected Parrot, a free platform for storing, sharing and collaborating on AI-based research."
sidebarTitle: "Expected Parrot"
---


The *Coop* module is EDSL's interface to [Expected Parrot](https://www.expectedparrot.com/content/explore), a free platform for creating, storing and sharing AI-based research, and validating it with human respondents. It is fully integrated with EDSL, allowing you to post, store and retrieve any objects that you've created with EDSL, together with data, notebooks and other project content.
