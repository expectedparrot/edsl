---
title: "Platform"
description: "Expected Parrot provides a free [platform](https://www.expectedparrot.com/content/explore) for creating, storing and sharing AI-based research, and validating it with human respondents. It is fully integrated with the open-source library (EDSL), allowing you to post, store, and retrieve any objects that you've created, together with data, notebooks and other project content. You can also explore public content and collaborate on projects privately with other users."
...
- Run surveys and post and share results at the Expected Parrot platform
- Use any available models with your surveys
- Access the universal cache of stored prompts and responses
...
Your Expected Parrot API key allows you to run surveys at Expected Parrot and store results at your account. When remote inference is activated, your survey jobs and results are automatically stored at and accessible at the [Results](https://www.expectedparrot.com/home/remote-inference) page of your account.

You can also post any EDSL objects to Expected Parrot from your workspace, including Results, Surveys, Agents, Scenarios, Notebooks and data files (using the FileStore module). To do this, you first need to store your Expected Parrot API key. If you have activated remote inference (at your [Settings](https://www.expectedparrot.com/home/settings) page), your key is automatically stored.
...
See details on methods for uploading, downloading, updating and deleting content at Expected Parrot below.
...
There are 2 methods for uploading/posting an object from your workspace:

1. Call the *push()* method on the object directly.
2. Call the *create()* method on a *Coop* client object and pass it the object.

You can optionally pass a description, a convenient alias, and a *visibility* status (public, private or unlisted (default)) when you create an object. These can be changed at any time.
...
There are 3 methods for updating/editing an object:
...
**On the Expected Parrot web app**

You can manually update the description or visibility of an object at the Expected Parrot web app. Navigate to the [Explore](https://www.expectedparrot.com/content/explore) page and open the page view for an object. You can select options to change the **visibility** of the object (*public*, *private* or *unlisted*) or to **edit** the description.
...
**Copy code on the Expected Parrot web app**

The Expected Parrot web app provides copyable code for downloading or reconstructing an object that has been posted:
...
There are 3 methods for deleting an object from Expected Parrot:
...
You can manually delete objects on the Expected Parrot web app:
...
If you have a feature request for the Expected Parrot platform, please let us know! There are several ways to do this:
