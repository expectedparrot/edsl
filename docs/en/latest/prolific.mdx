...
This generates a formatted dataset of [Results](/en/latest/results) that you can analyze with built-in methods. The survey, agents and results are also automatically added to your Expected Parrot account, where you can access them interactively.
</Step>
...
<Step title="Use Expected Parrot to launch Prolific studies">
...
project = survey.humanize(
    ...
    survey_alias = "vehicle-ownership-survey"  # optional, used to create a unique URL in addition to Expected Parrot UUID URL
)
