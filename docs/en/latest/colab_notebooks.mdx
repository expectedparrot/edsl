...
notebook.push(description="Posting a Colab notebook to Expected Parrot")
```

Example output:

```json
{'description': 'Posting a Colab notebook to Expected Parrot',
...
<Frame>
![Posting a Colab notebook to Expected Parrot](/images/en/latest/colab_notebooks_2.png)
</Frame>
