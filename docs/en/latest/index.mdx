...
<CardGroup>
<Card title="Shared state" icon="database" horizontal href="/en/latest/shared_state">
Define typed common data that coordinated interviews can read and update.
</Card>
<Card title="Research workflows" icon="diagram-project" horizontal href="/en/latest/workflows">
Orchestrate dependent tasks across human and simulated participants.
</Card>
</CardGroup>
