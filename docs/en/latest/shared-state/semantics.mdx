...
<Note>
This is the Draft 0.1 language specification. Its conformance requirements include targets beyond the current implementation, such as complete static typing and portable capability negotiation. Local
