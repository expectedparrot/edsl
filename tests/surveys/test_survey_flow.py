...
class TestSurveyFlow(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.middle_instruction = Instruction(
            text="Now we'll ask some follow-up questions.",
            name="middle"
        )
        self.end_instruction = Instruction(
            text="Thank you for your detailed responses!",
            name="end"
        )
    ...
    def test_single_instruction_at_beginning(self):
        ...
        third_item = survey.next_question_with_instructions(second_item, {'q0.answer': 'yes'})
    ...
    def test_instructions_with_rule_jumps(self):
        ...
        after_instruction = survey.next_question_with_instructions(next_item, {'q0.answer': 'yes'})
        ...
        after_instruction_no = survey.next_question_with_instructions(next_item_no, {'q0.answer': 'no'})
    ...
    def test_instruction_between_rule_jump_targets(self):
        ...
        survey = survey.add_instruction(self.middle_instruction)  # This should get index 1.5
        survey = survey.add_question(self.q2)
    ...
    def test_complex_multi_instruction_flow(self):
        ...
        # Add complex rules
        survey = survey.add_rule(self.q0, "{{ q0.answer }} == 'yes'", self.q2)  # Skip q1
        ...
        expected_path = ["intro", "q0", "middle1", "middle2", "q2", "end", "q3", "EndOfSurvey"]
